...
public class Constants {
    ...
    public static final String ERROR_ADDING_ORDER_ITEMS = "Error adding order items.";
    ...
    public static final String ORDER_ITEMS_ADDED_SUCCESSFULLY = "Order items added successfully.";
    ...
    public static final String CUSTOMER_ID_ALREADY_EXISTS = "Customer Id already exists";
    public static final int NUM_ERROR = 1;
    public static final int RIGHT = 0;
    public static final int NUM_ERROR1 = 2;
